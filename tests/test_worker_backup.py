...
def test_snapshot_preserves_existing_manifest_and_creates_no_partial_backup(database, tmp_path):
    destination = tmp_path / 'collision.sqlite3'
...
def test_restore_rejects_unrelated_database_before_creating_destination(database, tmp_path):
