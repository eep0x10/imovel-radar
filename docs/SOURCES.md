...
O modo gratuito é acionado exclusivamente pelo botão **Calcular rota até o metrô** de cada imóvel: limite global de 60 chamadas de rotas por dia (até 20 localizações novas com três candidatos), intervalo superior a um segundo e cache de 30 dias. Anúncios na mesma coordenada compartilham o cálculo. Falhas, ausência de coordenadas e esgotamento da cota ficam visíveis, sem números inventados. Nenhum cálculo é iniciado pela coleta ou pelo worker. O clique consulta somente a localização escolhida e grava somente esse anúncio; outros anúncios, inclusive na mesma coordenada, só recebem a rota após seus próprios cliques. Recoletas preservam rotas válidas apenas se a localização permanecer igual.
