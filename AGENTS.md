...
O Radar reúne filtros e comparação dinâmica. Minha jornada reúne favoritos e acompanhamento. Notificações são geradas por buscas salvas: registrar baseline na criação, nunca emitir avisos retroativos, deduplicar novas correspondências e isolar por usuário. Alterar o Radar não altera o snapshot dos alertas existentes. Configurações reúne conta, fontes, importações e diagnósticos.
